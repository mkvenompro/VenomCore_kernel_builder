#ifndef __LINUX_SOUTHCHIP_CHARGER_IRQ_H__
#define __LINUX_SOUTHCHIP_CHARGER_IRQ_H__

#define CHARGER_IRQ_HK           6
#define CHARGER_IRQ_CHARGER      0
#define CHARGER_IRQ_DPDM         3
#define CHARGER_IRQ_LED          2
#define CHARGER_IRQ_UFCS         5
#define CHARGER_IRQ_DVCHG        1
#define CHARGER_IRQ_CID          7
#define CHARGER_IRQ_MAX          8
