...
enum{
	...
	HARDWARE_VIBRATOR_IC, //add hardware information interface to vibrator ic
	HARDWARE_MAX_ITEM
};
...
#define HARDWARE_VIBRATOR_IC_GET                  _IOWR(HARDWARE_ID, 0x8C, char[HARDWARE_MAX_ITEM_LONGTH]) //add hardware information interface to vibrator ic
