 ...
 */
#ifndef __LINUX_LIXUN_CHARGER_PUMP_POLICY_H__
#define __LINUX_LIXUN_CHARGER_PUMP_POLICY_H__

#include "../charger_class/lx_adapter_class.h"
...
#endif /* __LINUX_LIXUN_CHARGER_PUMP_POLICY_H__ */
