...
static int nu6601_get_vbus_type(struct charger_dev *subpmic_dev, enum chg_type *vbus_type)
{
	struct nu6601_charger *chg = charger_get_private(subpmic_dev);
...
static int nu6601_is_charge_done(struct charger_dev *subpmic_dev, bool *done)
{
	...
	*done = _nu6601_get_chg_status(chg) == CHARGE_TERMINATION;
...
static int nu6601_get_charge_en(struct charger_dev *subpmic_dev, bool *en)
{
	struct nu6601_charger *chg = charger_get_private(subpmic_dev);
...
static irqreturn_t nu6601_chg_fsm_irq_handler(int irq, void *data)
{
	...
	chg_type = _nu6601_get_chg_status(chg);
...
static int nu6601_charger_init_setting(struct nu6601_charger *chg)
{
	...
	ret |= nu6601_set_otg_current(chg->subpmic_dev, chg->chg_cfg.otg_current);
