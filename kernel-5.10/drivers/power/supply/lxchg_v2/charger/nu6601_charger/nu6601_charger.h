...
#ifndef __NU6601_BUCK_CHARGER_H__
#define __NU6601_BUCK_CHARGER_H__
...
#define NU6601_REG_BC12_CTRL						(0xB5)
	...
	#define DPDM_PRI_THR_MASK		(0x10)
	#define DPDM_PRI_THR_SHIFT		(4)
	#define DPDM_PRI_THR_325MV		(0)
	#define DPDM_PRI_THR_425MV		(1)
...
void soft_qc35_update_dpdm_state(struct soft_qc35 *qc, enum soft_qc35_dpdm_state state);
