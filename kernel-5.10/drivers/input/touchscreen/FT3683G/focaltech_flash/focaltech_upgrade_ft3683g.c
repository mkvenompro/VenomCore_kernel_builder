...
int fts_read_lockdown_info_proc(u8 *buf)
{
	...
	if (ret < 0) {
		FTS_ERROR("fail to get vendor id from tp, use default !");
		lockdown_info[0] = 0x46;
		lockdown_info[1] = 0x36;
		lockdown_info[2] = 0x32;
		lockdown_info[3] = 0x10;
		lockdown_info[4] = 0x50;
		lockdown_info[5] = 0x37;
		lockdown_info[6] = 0x32;
