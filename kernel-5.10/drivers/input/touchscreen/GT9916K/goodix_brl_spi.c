...
#define TS_DRIVER_NAME		"goodix,gt9916K"
...
static int goodix_spi_probe(struct spi_device *spi)
{
	...
	spi->controller->cs_setup.value = 1;
	spi->controller->cs_setup.unit = 0;
	spi->controller->cs_hold.value = 1;
	spi->controller->cs_hold.unit = 0;
	spi->controller->cs_inactive.value = 1;
	spi->controller->cs_inactive.unit = 0;
