...
#include "ov20b40_ofilm_front_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV20B40_OFILM_FRONT_SENSOR_ID,
...
UINT32 OV20B40_OFILM_FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
