...
static struct platform_driver frsm_amp_driver = {
	.driver = {
		.name = "frsm-amp",
...
int frsm_platform_driver_register(void)
{
	return platform_driver_register(&frsm_amp_driver);
}

void frsm_platform_driver_unregister(void)
{
