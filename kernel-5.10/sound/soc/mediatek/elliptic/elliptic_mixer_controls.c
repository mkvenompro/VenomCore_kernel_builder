...
struct elliptic_system_configuration_parameter {
	...
	union {
		...
		int32_t lib_id;
		int32_t warm_up;
		int32_t input_channel_mapping[2];
		int32_t engine_param[2];
	};
};
...
static struct elliptic_engine_gyro_freq elliptic_engine_gyro_freq_data_cache = {0x7F};
...
static struct elliptic_shared_data_block shared_data_blocks[] = {
	...
	{ ELLIPTIC_OBJ_ID_GYRO_FREQ,
		...
		&elliptic_engine_gyro_freq_data_cache },
};
...
static uint32_t ultrasound_outchannel_num;

int elliptic_ultrasound_outchannel_get(struct snd_kcontrol *kcontrol,
                      struct snd_ctl_elem_value *ucontrol)
{
    ucontrol->value.integer.value[0] = ultrasound_outchannel_num;
    return 0;
}

int elliptic_ultrasound_outchannel_set(struct snd_kcontrol *kcontrol,
                      struct snd_ctl_elem_value *ucontrol)
{
    int32_t msg[4] = {0, 0, 0, 0};

    ultrasound_outchannel_num = ucontrol->value.integer.value[0];

	if(ultrasound_outchannel_num  > 2){
		pr_debug("[ELUS] Error: ultrasound_outchannel_num must be 0, 1 or 2\n");
		return -1;
	}

	msg[0] = ultrasound_outchannel_num;
	...
	struct snd_ctl_elem_value *ucontrol)
{
	...
	case ELLIPTIC_SYSTEM_CONFIGURATION_LIB_ID:
		...
		break;
	case ELLIPTIC_SYSTEM_CONFIGURATION_WARM_UP:
		ucontrol->value.integer.value[0] =
			elliptic_system_configuration_cache.warm_up;
		break;
	case ELLIPTIC_SYSTEM_CONFIGURATION_INPUT_CHANNEL_MAP:
		ucontrol->value.integer.value[0] =
			elliptic_system_configuration_cache.input_channel_mapping[0];
		ucontrol->value.integer.value[1] =
			elliptic_system_configuration_cache.input_channel_mapping[1];
		break;
	case ELLIPTIC_SYSTEM_CONFIGURATION_ENGINE_PARAM:
		ucontrol->value.integer.value[0] =
			elliptic_system_configuration_cache.engine_param[0];
		ucontrol->value.integer.value[1] =
			elliptic_system_configuration_cache.engine_param[1];
		break;
	default:
	...
	struct snd_ctl_elem_value *ucontrol)
{
	...
	case ELLIPTIC_SYSTEM_CONFIGURATION_INPUT_CHANNEL_MAP:
		...
		elliptic_system_configuration_cache.input_channel_mapping[1] =
			ucontrol->value.integer.value[1];
		param.type = ESCPT_INPUT_CHANNEL_MAP;
		param.input_channel_mapping[0] =
			elliptic_system_configuration_cache.input_channel_mapping[0];
		param.input_channel_mapping[1] =
			elliptic_system_configuration_cache.input_channel_mapping[1];
		pr_info("ELUS INPUT_CHANNEL_MAP param.input_channel_mapping(%d, %d)\n", param.input_channel_mapping[0], param.input_channel_mapping[1]);
		break;
	case ELLIPTIC_SYSTEM_CONFIGURATION_ENGINE_PARAM:
		elliptic_system_configuration_cache.engine_param[0] =
			ucontrol->value.integer.value[0];
		elliptic_system_configuration_cache.engine_param[1] =
			ucontrol->value.integer.value[1];
		param.type = elliptic_system_configuration_cache.engine_param[0];
		param.engine_param[0] =
			elliptic_system_configuration_cache.engine_param[1];
		param.engine_param[1] = 0;
		pr_info("ELUS ENGINE_PARAM type=%d, value(%d, %d)\n",param.type, param.input_channel_mapping[0], param.input_channel_mapping[1]);
		break;
	default:
		return -EINVAL;
	}
...
static const struct snd_kcontrol_new ultrasound_filter_mixer_controls[] = {
	...
	SOC_SINGLE_EXT("Ultrasound Warm Up",
	ELLIPTIC_SYSTEM_CONFIGURATION,
	ELLIPTIC_SYSTEM_CONFIGURATION_WARM_UP,
	256,
	0,
	elliptic_system_configuration_param_get,
	elliptic_system_configuration_param_put),

    SOC_DOUBLE_EXT("Ultrasound Input Channel",
	ELLIPTIC_SYSTEM_CONFIGURATION,
	ELLIPTIC_SYSTEM_CONFIGURATION_INPUT_CHANNEL_MAP,
	0,
	0xFFFFFFFF,
	0,
	elliptic_system_configuration_param_get,
	...
	SOC_DOUBLE_EXT("Ultrasound Engine Param",
	ELLIPTIC_SYSTEM_CONFIGURATION,
	ELLIPTIC_SYSTEM_CONFIGURATION_ENGINE_PARAM,
	0,
	0xFFFFFFFF,
	0,
	elliptic_system_configuration_param_get,
	...
	SOC_ENUM_EXT("Ultrasound OutChannel",
	elliptic_enum[0],
	elliptic_ultrasound_outchannel_get,
	elliptic_ultrasound_outchannel_set),
