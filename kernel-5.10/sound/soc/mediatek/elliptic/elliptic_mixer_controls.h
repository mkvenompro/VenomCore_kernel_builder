...
#define ELLIPTIC_OBJ_ID_GYRO_FREQ 9
#define ELLIPTIC_GYRO_FREQ_SIZE  4
...
#define ELLIPTIC_SYSTEM_CONFIGURATION_WARM_UP 34
#define ELLIPTIC_SYSTEM_CONFIGURATION_INPUT_CHANNEL_MAP  36
#define ELLIPTIC_SYSTEM_CONFIGURATION_ENGINE_PARAM  37
...
struct elliptic_engine_gyro_freq {
        int32_t freq_valule;
};
...
enum elliptic_system_configuration_parameter_type {
	...
	ESCPT_LIB_ID, //43
	ESCPT_WARM_UP = ESCPT_LIB_ID + 9,
	ESCPT_INPUT_CHANNEL_MAP = ESCPT_LIB_ID + 20,
};
